...
export default function Hero() {
  ...
  return (
    <main className="flex flex-col items-center mt-5 relative">
       <div className="text-2xl sm:text-4xl font-bold text-center mb-2 tracking-wide text-yellow-50">Unified Borrowing</div>
       <div className="text-center mb-5 text-base sm:text-lg text-yellow-50">Powered by <span className="bg-yellow-200 text-neutral-900 rounded-lg px-2 py-1 font-bold ml-2">pawUSDC</span></div>
